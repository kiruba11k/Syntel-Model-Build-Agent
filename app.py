...
# --- Configuration ---
# Set these in Streamlit Cloud secrets: SERPER_API_KEY
...
# Initialize LLM - Using a more compatible approach
def get_llm():
    try:
        # Try using a local model or fallback
...
st.markdown("### Powered by CrewAI and Serper Search")
...
with st.sidebar.expander("Setup Instructions"):
    ...
    **Required API Keys (set in Streamlit Cloud secrets):**
    - `SERPER_API_KEY`: Get from serper.dev - $50 free credit
